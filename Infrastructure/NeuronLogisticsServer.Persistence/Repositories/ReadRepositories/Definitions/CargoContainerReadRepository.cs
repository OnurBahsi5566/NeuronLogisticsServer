...
{
    public class CargoContainerReadRepository : ReadRepository<CargoContainer>,ICargoContainerReadRepository
    {
        public CargoContainerReadRepository(NeuronLogisticsServerDbContext context) : base(context)
        {
        }
    }
}